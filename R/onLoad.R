		...
		tc = list(cbfriendly = list('NA' = "",
			 ...
			 harmony = list(cat = list('NA' = "",
			 			   ...
			 			   x = list('NA' = "",
			 					 'M' = "",
			 					 'L' =  kableExtra::cell_spec("&#x2260;",
			 					 							 tooltip = "Inequity: colors are not equally vivid. See tab 'HCL Analysis'", escape = FALSE,
			 					 							 extra_css = "font-size: 80%; vertical-align: -0.1em; line-height: 0px;"),
			 					 'H' = kableExtra::cell_spec("&#x3d;",
			 					 							tooltip = "Equity: colors are equally vivid. See tab 'HCL Analysis'", escape = FALSE,
			 					 							extra_css = "font-size: 80%; vertical-align: -0.1em; line-height: 0px;"))),
			 contrast = list('NA' = "",
			 				'FALSE' =  "",
